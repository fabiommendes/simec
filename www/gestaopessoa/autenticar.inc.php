<?
	...
	function erro(){
		...
		header( "Location: ". $_SERVER['PHP_SELF']."?cpf=".$_REQUEST['usucpf'] );
		exit();
	}
	...
	$alerta = array(
		...
		'permissao' => "Você não possui permissão de acesso ao módulo de Gestão de Pessoas.",
	);
