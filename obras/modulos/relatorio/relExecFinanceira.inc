...
if ( $_REQUEST['pesquisa'] ){
	include "resultadoExecFinanceira.inc";
	die;
}
...
monta_titulo( 'Execução Financeira de Convênios de Infraestrutura', 'Selecione os filtros e agrupadores desejados' );
				...
				<?php
					...
					$origem = array(
						...
						'classificacao' => array(
							...
							'descricao' => 'Classificação da Obra'
						),
						'nomedaobra' => array(
							'codigo'    => 'nomedaobra',
			...
			<?php
				...
				$stSql = " SELECT 
						   ...
						   WHERE 
						   		...
						   		oi.obsstatus = 'A'";
				mostrarComboPopup( 'Campus', 'campus',  $stSql, $stSqlCarregados, 'Selecione a(s) Unidade(s)' );
