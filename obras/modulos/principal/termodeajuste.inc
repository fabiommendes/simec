...
// quando o usuário seleciona o termo de ajuste pela lista, cria a sessão
if ( $_REQUEST['traid'] ){
...
// verifica o tipo de requisicao da tela ( inserção / atualização )
			...
			<td colspan="2">
				<div id="listaParticipantes">
					<?php 
						...
						$cabecalho = array( "Ação", "CPF", "Nome do Autor", "Unidade" );
