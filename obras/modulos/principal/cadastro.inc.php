...
<!--
	<tr>
		...
		//		}
		//
		// Carrega arrays javascript com as descrições da tipologia
		$tpodetalhe = '';
...
//		$habil = 'S';//($cloid && $prfid) ? 'N' : 'S';
	...
	<tr>
		<td class="SubTituloDireita">Tipo de Aquisição do Terreno</td>
		<td><?php
	...
	<tr>
		<td colspan="3" class="subtitulocentro">Responsáveis pela Obra</td>
	</tr>
	<tr>
		<td colspan="3">
