...
<html>
	<head>
		...
		<script src="http://maps.google.com/maps?file=api&amp;v=2&amp;sensor=false&amp;key=<?php echo $GLOBALS['parametros_chave_googlemaps'][$local[2]];?>" type="text/javascript"></script>
