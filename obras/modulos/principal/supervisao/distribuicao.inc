...
monta_titulo( "Distribuição de Lotes", "" );
...
$(document).ready(function() {
	...
	$("#semos").click(function () {
		...
		// verificando se os campos estão desabilitados
	...
	$("#orgid").change(function () {
		...
		//se orgid não possuir valor então eu saio da função
		if(!orgid){
...
<form action="" method="post" name="formulario" id="obrFormPesLote">
	...
	<table class="tabela" bgcolor="#f5f5f5" cellSpacing="1" cellPadding=3 align="center">
		...
		<tr>
			<td class="SubTituloDireita" width="190px">Situação Supervisão do Grupo (Empresa):</td>
			<td>
				<?php 
		...
		<tr>
			<td class="SubTituloDireita" width="190px">Situação Supervisão da Obra (Empresa):</td>
			<td>
				<?php 
